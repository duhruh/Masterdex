...
public class ImageDownloader {
     ...
     */
    public void download(String url, ImageView imageView, ImageView spin) {
        this.spin = spin;
    	download(url, imageView,spin, null);
    }
     ...
     */
    public void download(String url, ImageView imageView,ImageView spin, String cookie) {
        resetPurgeTimer();
